		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... params) {
				try {
					...
					/*try {
						// this has heterogeneous faces
						Object3DData data = ColladaLoader.load(new URL("android://com.hrily.artutorial/assets/models/cowboy.dae"));
						loadTexture(data, new URL("android://com.hrily.artutorial/assets/models/cowboy.png"));
