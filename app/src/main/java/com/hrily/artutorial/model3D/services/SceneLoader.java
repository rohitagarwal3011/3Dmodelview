package com.hrily.artutorial.model3D.services;
...
import com.hrily.artutorial.model3D.animation.Animator;
import com.hrily.artutorial.model3D.collision.CollisionDetection;
import com.hrily.artutorial.model3D.model.Object3DBuilder;
import com.hrily.artutorial.model3D.model.Object3DBuilder.Callback;
import com.hrily.artutorial.model3D.model.Object3DData;
import com.hrily.artutorial.model3D.view.ModelActivity;
import com.hrily.artutorial.util.url.android.Handler;
		...
		if (parent.getParamFile() != null || parent.getParamAssetDir() != null) {
			...
			try {
				if (parent.getParamFile() != null) {
					...
					url = new URL("android://com.hrily.artutorial/assets/" + parent.getParamAssetDir() + File.separator + parent.getParamAssetFilename());
