package com.hrily.artutorial.model3D.model;
...
import com.hrily.artutorial.model3D.services.WavefrontLoader.FaceMaterials;
import com.hrily.artutorial.model3D.services.WavefrontLoader.Faces;
import com.hrily.artutorial.model3D.services.WavefrontLoader.Material;
import com.hrily.artutorial.model3D.services.WavefrontLoader.Materials;
import com.hrily.artutorial.model3D.services.WavefrontLoader.Tuple3;
import com.hrily.artutorial.model3D.services.collada.loader.ColladaLoader;
import com.hrily.artutorial.model3D.services.stl.STLLoader;
import com.hrily.artutorial.model3D.services.wavefront.WavefrontLoader2;
import com.hrily.artutorial.util.math.Math3DUtils;
...
public final class Object3DBuilder {
	...
	static {
		System.setProperty("java.protocol.handler.pkgs", "com.hrily.artutorial.util.url|"+System.getProperty("java.protocol.handler.pkgs"));
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(com.hrily.artutorial.model3D.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(com.hrily.artutorial.model3D.entities.BoundingBox box) {
		//@formatter:off
